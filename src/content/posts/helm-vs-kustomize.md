...
Before reading this article, if you want to follow along and try command on your own computer, make sure to install `Helm` and `Kustomize` using these links:
