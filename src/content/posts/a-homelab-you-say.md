...
<img loading="lazy" src="/img/blog/initial_pi_cluster.webp" alt="Initial Cluster" width="300" class="rounded-lg">
<br/>

The NAS with HDDs inside of it (which is used as an NFS server):

<img loading="lazy" src="/img/blog/nas_with_hdds.webp" alt="NAS with HDDs" width="700" class="rounded-lg">
<br/>

Finally, the NAS and the Pi Cluster on my desk:

<img loading="lazy" src="/img/blog/lab_on_desk.webp" alt="NAS with Cluster" width="700" class="rounded-lg">
...
<img loading="lazy" src="/img/blog/front_rack.webp" alt="Front of the rack" width="550" class="rounded-lg">
<br/>

A picture from another angle that shows the entire rack:

<img loading="lazy" src="/img/blog/whole_rack.webp" alt="Top of the rack" width="550" class="rounded-lg">
