...
{{< lead >}}
J'ai commencé la photographie mi-2025 quand j'ai acheté ma première caméra. Voici quelques-unes de mes photos préférées prises à travers le monde depuis.
{{< /lead >}}
...
<figure class="photo-figure photo-figure-portrait">
  <img class="blur-load rounded-lg"
    ...
    alt="Lunch">
  <figcaption>Lunch, au centre-ville de Montréal.</figcaption>
</figure>

### Un monument montréalais
...
<figure class="photo-figure photo-figure-portrait">
  ...
  <figcaption>Un homme qui s'en va quelque part, devant de beaux arbres, à Nepean.</figcaption>
</figure>
...
<figure class="photo-figure photo-figure-portrait">
  <img class="blur-load rounded-lg"
    ...
    alt="Rue de Prague">
  <figcaption>Une rue colorée de Prague.</figcaption>
</figure>
...
<figure class="photo-figure photo-figure-portrait">
  <img class="blur-load rounded-lg"
    ...
    alt="Le bureau">
  <figcaption>Le chemin vers le bureau de Lightspeed.</figcaption>
</figure>
